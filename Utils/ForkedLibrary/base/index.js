...
exports.PaginationEmbed = class extends t.EventEmitter {
  ...
  async _drawEmojis() {
    ...
    this.listenerCount("start") && this.emit("start",this), this._awaitResponse();
  }
  ...
  async _cleanUp(t, e, i = !0, s) {
    ...
    this.listenerCount(a) && this.emit(a, s,this);
  }
  async _awaitResponseEx(t) {
    ...
    try {
      ...
      this.listenerCount("expire") && this.emit("expire",this);
    }
  }
};